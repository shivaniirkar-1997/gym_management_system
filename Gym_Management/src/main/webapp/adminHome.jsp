      ...
      <li><hr class="dropdown-divider"></li>
        ...
        <button style="border: none;outline: none;"> Reset Reservations</button>
         ...
         <li class="nav-item mx-2">
          <a href="#" title="Instagram"><img src="./img/inshtagram.jpg" style="height: 35px;width:35px;border-radius: 100px 100px;" alt="not found"></a>
        </li>
         <li class="nav-item mx-1">
         <a href="#" title="Facebook"><img src="./img/facebook.jpg" style="height: 35px;width:35px;border-radius: 100px 100px;" alt="not found"></a>
        </li>
         <li class="nav-item mx-1">
         <a href="#" title="WhatsApp" ><img src="./img/whatapp.jpg" style="height: 35px;width:35px;border-radius: 100px 100px;" alt="not found"></a>
        </li>
    </div>
